                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($employees as $employee => $value)
                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        <td>
                                            <a data-bs-toggle="modal" data-bs-target="#backDropModal{{ $value->id }}"
                                                data-bs-toggle="modal" data-bs-target="#backDropModal">
                                                <i class='bx bx-folder-plus'></i>
                                            </a>
                                            <a href="{{ url('/admin/employee-work-information') }}/{{ $value->id }}"><i
                                        ...
                                        @php
                                            $late = DB::table('employee_works')
                                                ->where('employee_id', $value->id)
                                                ->orderBy('id', 'desc')
                                                ->value('late');
                                            $absence = DB::table('employee_works')
                                                ->where('employee_id', $value->id)
                                                ->orderBy('id', 'desc')
                                                ->value('absence');
                                        @endphp
                                        ...
                                        @if ($salary != null)
                                            @php
                                                ...
                                                $charge = DB::table('employee_works')
                                                    ->where('employee_id', $value->id)
                                                    ->orderBy('id', 'desc')
                                                    ->value('charge');
                                                ...
                                                $insurance = DB::table('employee_works')
                                                    ->where('employee_id', $value->id)
                                                    ->orderBy('id', 'desc')
                                                    ->value('insurance');
                                                ...
                                                $deduct = DB::table('employee_works')
                                                    ->where('employee_id', $value->id)
                                                    ->orderBy('id', 'desc')
                                                    ->value('deduct');
