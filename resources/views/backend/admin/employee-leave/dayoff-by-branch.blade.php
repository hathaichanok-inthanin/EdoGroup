                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" data-bs-toggle="modal"
                                                        ...
                                                        data-bs-target="#backDropModal"><i class='bx bxs-folder-plus'></i>
                                                        เพิ่มวันลา</a>
                                                    <a class="dropdown-item"
                                                        href="{{ url('/admin/dayoff-information') }}/{{ $branch_id }}/{{ $value->id }}"><i
                                                            class='bx bxs-folder-open'></i> ข้อมูลเพิ่มเติม</a>
                                                </div>
                                            </div>
                                            <!-- Modal -->
                                            <div class="modal fade" id="backDropModal{{ $value->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <form action="{{ url('admin/create-dayoff') }}" method="POST"
                                                        enctype="multipart/form-data" class="modal-content">@csrf
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="backDropModalTitle">วันหยุดประจำปี
                                                            </h5>
