                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        <td>
                                            ...
                                            <a
                                                href="{{ url('/admin/provident-fund-information') }}/{{ $branch_id }}/{{ $value->id }}"><i
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="backDropModal{{ $value->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <form action="{{ url('admin/create-provident-fund') }}" method="POST"
                                                        enctype="multipart/form-data" class="modal-content">@csrf
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="backDropModalTitle">กรอกเงินสะสม
                                                            </h5>
