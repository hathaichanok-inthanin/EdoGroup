                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        <td>
                                            ...
                                            <a
                                                href="{{ url('/admin/salary-information') }}/{{ $branch_id }}/{{ $value->id }}"><i
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="backDropModal{{ $value->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <form action="{{ url('admin/create-salary') }}" method="POST"
                                                        enctype="multipart/form-data" class="modal-content">@csrf
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="backDropModalTitle">กรอกเงินเดือน
                                                            </h5>
